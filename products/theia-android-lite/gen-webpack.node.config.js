 ...
 * To customize webpack configuration change /home/muhammad-taha/Downloads/work/theia/products/theia-android-lite/webpack.config.js
 */
// @ts-check
...
const config = {
    ...
    entry: {
        ...
        'plugin-host': require.resolve('@theia/plugin-ext/lib/hosted/node/plugin-host'),        ...commonJsLibraries
    },
    module: {
        rules: [
