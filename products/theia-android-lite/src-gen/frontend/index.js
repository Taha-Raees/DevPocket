...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, import('@theia/mobile-shell/lib/browser/mobile-shell-frontend-module'));
        await load(container, import('@theia/theia-command-console/lib/browser/theia-command-console-frontend-module'));
